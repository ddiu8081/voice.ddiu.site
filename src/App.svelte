...
<main class="container max-w-prose mx-auto mt-16 mb-10 px-6 md:px-0">
  <header class="py-2">
    <Icon class="text-6xl" icon="twemoji:radio" />
    <h1 class="text-3xl font-semibold mt-6">Diu Voice Server</h1>
    <p class="opacity-50 mt-2">又一个位于中国的 TeamSpeak 服务器。</p>
  </header>
  <article>
    <div class="my-8">
      <h2 class="uppercase opacity-50 text-sm">服务器地址</h2>
      <div
  ...
  <div class="my-8">
    ...
    <div class="flex flex-col mt-2 text-gray-700">
      <div
        class="flex py-4 px-4 -mx-4 my-2 rounded-lg md:hover:bg-slate-100"
      >
        <Icon class="shrink-0 mr-4 text-2xl md:text-3xl opacity-80" icon="twemoji:keycap-1" />
        <div class="my-0.5">
      ...
      <div
        class="flex py-3 px-4 -mx-4 my-2 rounded-lg md:hover:bg-slate-100"
      >
        <Icon class="shrink-0 mr-4 text-2xl md:text-3xl opacity-80" icon="twemoji:keycap-2" />
        <div class="my-0.5">
      ...
      <div
        class="flex py-3 px-4 -mx-4 my-2 rounded-lg md:hover:bg-slate-100"
      >
        <Icon class="shrink-0 mr-4 text-2xl md:text-3xl opacity-80" icon="twemoji:keycap-3" />
        <div class="my-0.5">
      ...
      <div
        class="flex py-3 px-4 -mx-4 my-2 rounded-lg md:hover:bg-slate-100"
      >
        <Icon class="shrink-0 mr-4 text-2xl md:text-3xl opacity-80" icon="twemoji:keycap-4" />
        <div class="my-0.5">
          选择一个房间，开始语音聊天。
        </div>
      </div>
